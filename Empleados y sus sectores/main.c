...
void mostrarEmpleado(eEmpleado emp)
{
    ...
    printf("%s   %d   %s   %c    %.2f\n    %02d/%02d/%02d", emp.sector.nombre,
            emp.legajo, emp.nombre, emp.sexo, emp.sueldo,
            emp.fechaDeNacimiento.dia, emp.fechaDeNacimiento.mes,
            emp.fechaDeNacimiento.anio);
...
void altaEmpleado(eEmpleado vec[], int tam)
{
    ...
    else
    {
        ...
        if( esta == -1)
        {
            ...
            fflush(stdin);
            gets(vec[indice].sector.nombre);

            printf("Ingrese fecha de nacimiento dd mm aaaa: ");
            fflush(stdin);
            scanf("%d %d %d", &vec[indice].fechaDeNacimiento.dia,
                              &vec[indice].fechaDeNacimiento.mes,
                              &vec[indice].fechaDeNacimiento.anio);
...
void sumarSueldos(eEmpleado vec[], int tam)
{
    ...
    printf("El total de todos los sueldos es: %d", totalSueldo);
